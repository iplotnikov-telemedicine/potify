...
explore: discount {
  join: product_filter {
    type: left_outer
    sql_on: ${discount.product_filter_id} = ${product_filter.id} ;;
    relationship: many_to_one
  }
}
...
explore: discount_collection_group {
  join: collection_group {
    type: left_outer
    sql_on: ${discount_collection_group.collection_group_id} = ${collection_group.id} ;;
    relationship: many_to_one
  }

  join: discount {
    type: left_outer
    sql_on: ${discount_collection_group.discount_id} = ${discount.id} ;;
    relationship: many_to_one
  }
...
explore: discount_medibook_office_ref {
  join: discount {
    type: left_outer
    sql_on: ${discount_medibook_office_ref.discount_id} = ${discount.id} ;;
    relationship: many_to_one
  }
...
explore: discount_patient_group_ref {
  join: discount {
    type: left_outer
    sql_on: ${discount_patient_group_ref.discount_id} = ${discount.id} ;;
    relationship: many_to_one
  }

  join: patient_group {
    type: left_outer
    sql_on: ${discount_patient_group_ref.patient_group_id} = ${patient_group.id} ;;
    relationship: many_to_one
  }
...
explore: discount_patient_type_ref {
  join: discount {
    type: left_outer
    sql_on: ${discount_patient_type_ref.discount_id} = ${discount.id} ;;
    relationship: many_to_one
  }

  join: patient_type {
    type: left_outer
    sql_on: ${discount_patient_type_ref.patient_type_id} = ${patient_type.id} ;;
    relationship: many_to_one
  }
...
explore: indica_sync_shop_order_log {
  join: shop_order {
    type: left_outer
    sql_on: ${indica_sync_shop_order_log.shop_order_id} = ${shop_order.id} ;;
    relationship: many_to_one
  }
...
explore: mb_office {
  ...
  join: collection_group {
    type: left_outer
    sql_on: ${mb_office.collection_group_id} = ${collection_group.id} ;;
    relationship: many_to_one
  }
}
...
explore: patient_group {}

explore: patient_patient_group_ref {
  join: patient_group {
    type: left_outer
    sql_on: ${patient_patient_group_ref.patient_group_id} = ${patient_group.id} ;;
    relationship: many_to_one
  }

  join: patient {
    type: left_outer
    sql_on: ${patient_patient_group_ref.patient_id} = ${patient.merged_to_patient_id} ;;
    relationship: many_to_one
  }
...
explore: product_filter {}

explore: product_filter_index {
  join: product_filter {
    type: left_outer
    sql_on: ${product_filter_index.product_filter_id} = ${product_filter.id} ;;
    relationship: many_to_one
  }

  join: product {
    type: left_outer
    sql_on: ${product_filter_index.product_id} = ${product.brand_product_id} ;;
    relationship: many_to_one
  }
...
explore: staff_brands_ref {
  join: staff {
    type: left_outer
    sql_on: ${staff_brands_ref.staff_id} = ${staff.id} ;;
    relationship: many_to_one
  }

  join: brand {
    type: left_outer
    sql_on: ${staff_brands_ref.brand_id} = ${brand.id} ;;
    relationship: many_to_one
  }
...
explore: tax_additional_product_category_ref {
  join: tax_additional {
    type: left_outer
    sql_on: ${tax_additional_product_category_ref.tax_additional_id} = ${tax_additional.id} ;;
    relationship: many_to_one
  }
